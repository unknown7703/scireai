...
const Landing = () => {
  return (
    <div className="flex flex-col w-full h-full overflow-y-auto justify-center">
      {/* Navigation Bar */}
      ...
      >
        <div className="bg-blue-200/20 p-10 drop-shadow-md rounded-2xl backdrop-blur-md w-[70%]">
          <h1 className=" max-w-[80%] justify-self-center text-center text-6xl font-bold">
            Accelerate your speed of reading{" "}
            <p className="italic font-extrabold">research papers</p>
          </h1>

          <p className="text-white stroke-slate-900 text-lg max-w-[70%] mt-8 tracking-wide text-center justify-self-center">
            Research faster without leaving the window with AI-powered features
            like Term Look Up and Chat{" "}
          </p>
      ...
      {/* Features Carousel */}
      <section className="flex flex-col items-center justify-center mt-48 mb-28 my-8">
        <h2 className="text-6xl text-black tracking-wide font-bold mb-16">
          Our Features
        </h2>
        <div className="flex px-16 justify-between gap-2 flex-row">
          <div className="p-2 bg-[#0062CC] rounded-lg text-white max-w-[32%]">
            <video
              className="w-[80%] justify-self-center mt-8 mb-2 rounded-xl"
              autoPlay
              muted
              loop
              playbackRate="2"
            ...
            <h3 className="text-3xl justify-self-center font-semibold my-2 mb-6 ">
              Term Lookup
            </h3>
            <p className="justify-self-center mb-4 text-lg max-w-[60%] text-center">
              Just right click and understand complex terms instantly, without
              leaving your window.
            </p>
          </div>
          <div className="p-4 bg-[#0062CC] rounded-lg text-white max-w-[32%]">
            ...
            <p className="justify-self-center mb-4 text-lg max-w-[60%] text-center">
              Chat seamlessly with ScireAI, right where you read your papers
            </p>
          </div>
          <div className="p-4 bg-[#0062CC] rounded-lg text-white max-w-[32%]">
            <video
            ...
            <p className="justify-self-center mb-4 text-lg max-w-[60%] text-center">
              Frictionless and intuitive, SciraAI simplifies research with
              effortless, seamless usability
            </p>
          </div>
        </div>
      </section>
      <div className="w-full mb-2">
        <div className=" flex flex-row italic justify-self-center mb-2">
          made by &nbsp;
          <p>
            <Link
              className="text-blue-600"
              to="https://github.com/pranitmalhotra"
            >
              Pranit Malhotra
            </Link>{" "}
            and &nbsp;
          ...
          <p className="text-blue-600">
            <Link to="https://github.com/unknown7703">T Aatreya</Link>
          </p>
        </div>
      </div>
    </div>
